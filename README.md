# Bee AI Verse — Login, Register, Deposit, Withdraw
...
Then just open **http://localhost:5000** in Chrome (it serves the new
`index.html` marketing homepage, with Log In / Register buttons). No Live
Server extension, no separate frontend server, no CORS setup needed —
everything runs from this one server.
