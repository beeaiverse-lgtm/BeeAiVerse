...
const USER_NAV = [
  ...
  { key: 'business-plan',  href: 'business-plan.html',   icon: '⬢', label: 'Business Plan' },
  ...
  { key: 'bav-coin',       href: 'bav-coin.html',        icon: '🪙', label: 'Upcoming BAV Coin' },
];

const ADMIN_NAV = [
  { key: 'overview',    href: 'beeadmin-dashboard.html',            icon: '⌂', label: 'Overview' },
  { key: 'users',       href: 'beeadmin-users.html',      icon: '⬡', label: 'Users' },
  { key: 'business',    href: 'beeadmin-business.html',   icon: '⬢', label: 'Business' },
  { key: 'deposits',    href: 'beeadmin-deposits.html',   icon: '⬆', label: 'Deposits' },
  { key: 'withdrawals',      href: 'beeadmin-withdrawals.html',           icon: '⬇', label: 'Withdrawals' },
  { key: 'bulk-process',    href: 'beeadmin-processing-withdrawals.html', icon: '⚡', label: 'Bulk Process' },
  { key: 'notifications', href: 'beeadmin-notifications.html', icon: '🔔', label: 'Notifications' },
  { key: 'reports',     href: 'beeadmin-reports.html',    icon: '◆', label: 'Reports' },
  { key: 'db-viewer',   href: 'beeadmin-db-viewer.html',  icon: '⛁', label: 'DB Viewer' },
  { key: 'support',     href: 'beeadmin-support.html',    icon: '✦', label: 'Support' },
  { key: 'security',    href: 'beeadmin-security.html',   icon: '🔒', label: 'Security' },
];
