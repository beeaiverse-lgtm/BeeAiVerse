...
// Wires up the mobile hamburger drawer and the topbar logout icon on every
// page automatically. Safe no-op on pages that don't have these elements
// (e.g. login/register).
document.addEventListener('DOMContentLoaded', () => {
  ...
  // The logout control is now an icon button/link in the topbar; give it a
  // click handler here too so pages don't each need their own listener.
